          ...
          <div className="card shadow p-4">
            <div className="d-flex flex-column align-items-center mb-4">
              <img
                ...
                style={{ width: 90, height: 90, objectFit: "cover", border: "3px solid #4caf50" }}
              />
            </div>
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    {avatarList.map((avatar, idx) => (
                      <img
                        ...
                        src={avatar}
                        alt={`avatar-${idx}`}
                        className={`rounded-circle border ${selectedAvatar === avatar ? "border-success border-3" : "border-2"}`}
                        style={{
                          width: "60px",
                          height: "60px",
                          cursor: "pointer",
